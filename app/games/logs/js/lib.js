...
function loadJSON(url, callback, errorCallback) {
  ...
  xmlHttpRequest.onreadystatechange = () => {
    ...
    if (
      ...
      String(xmlHttpRequest.status) === "200"
    ) {
...
function postRequest(url, obj, callback) {
  ...
  xmlHttpRequest.onerror = (e) => {
    callback({
      type: "error",
      error_code: "001",
      msg: "error in server call on error",
    });
  };
...
function getFormattedAmount(amount, amountwithoutcurrency) {
  ...
  if (
    Object.keys(config).indexOf(currencyCode) >= 0 &&
    amount >= config[currencyCode].minAmount &&
    amount < config[currencyCode].maxAmount
  ) {
    if (currencyCode === "eur") {
      if (
        _lang === "pt_pt" ||
...
function setCurrency(curcyCode) {
  ...
  switch (code) {
    ...
    case "myr":
      _langFormat = (value) =>
        currency(value, { symbol: "‎RM ", separator: ",", decimal: "." });
    ...
    case "twd":
      _langFormat = (value) =>
        currency(value, { symbol: "NT$", separator: ",", decimal: "," });
    ...
    case "ar":
      _langFormat = (value) =>
        currency(value, { symbol: "د.إ ", separator: "", decimal: "," });
    ...
    case "brl":
      _langFormat = (value) =>
        currency(value, { symbol: "R$", separator: ".", decimal: "," });
      setCurrencySymbol("R$");
      break;
    case "cad":
      _langFormat = (value) =>
    ...
    case "ghs":
      _langFormat = (value) =>
        currency(value, { symbol: "GH¢", separator: ",", decimal: "." });
      setCurrencySymbol("GH¢");
      break;
    case "hkd":
      _langFormat = (value) =>
        currency(value, { symbol: "HK$", separator: ",", decimal: "." });
      setCurrencySymbol("HK$");
      break;
    case "isk":
      _langFormat = (value) =>
        currency(value, { symbol: "kr", separator: ".", decimal: "," });
      setCurrencySymbol("kr");
      break;
    case "mxn":
      _langFormat = (value) =>
    ...
    case "pen":
      _langFormat = (value) =>
        currency(value, { symbol: "S/", separator: ",", decimal: "." });
      setCurrencySymbol("S/");
      break;
    case "php":
      _langFormat = (value) =>
    ...
    case "chf":
      _langFormat = (value) =>
        currency(value, { symbol: "CHf ", separator: " ", decimal: "." });
    ...
    default:
      _langFormat = (value) =>
        currency(value, { symbol: currencyCode, separator: ",", decimal: "." });
  }
}
