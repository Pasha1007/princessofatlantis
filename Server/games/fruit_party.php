...
QUERY;
            ...
            // "0:40::6:e:;1:75::5:b:;2:640::7:f:;3:20::5:g:"
            // if($detail_data == true){
            ...
            if($server_response["current_round"]["sub_game"] == 1){
                $this->bg1 += 1;
            ...
            elseif($server_response["current_round"]["sub_game"] == 2){
                ...
                if (array_key_exists('type', $resp_fg[0])) {
                    if ($resp_fg[0]['type'] == "freespins") {
                        ...
                        while ($fs == true ) {
                            ...
                            $request_params_sim['game_id'] = $this->game_id;
                            $request_params_sim['amount_type'] = 1;
                            // $request_params_sim['sub_game_id'] = 2; // , normal
        ...
        // echo "1";
        // echo "total_win_simulation = ",$this->total_win_simulation;
        // echo "total_bet_simulation = " , $this->total_bet_simulation;
