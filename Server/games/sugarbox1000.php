...
QUERY;
            ...
            // $this->total_bet_simulation += $this->coin_value_sim *$this->num_coins_sim *500; //buy fg game
            #=========================================================
            ...
            // $request_params_sim['sub_game_id'] = 7; // Super buy fg
            ...
            // echo "base ,", $server_response["current_round"]["win_amount"];
                ...
                if (array_key_exists('type', $resp_fg[0])) {
                    if ($resp_fg[0]['type'] == "freespins") {
                        ...
                        while ($fs == true ) {
                            ...
                            // $request_params_sim['sub_game_id'] = 8; // Super buy fg
                            ...
                            $res = s_main($request_params);
                            echo $co+=1, count($server_response["next_round"]);
                            // print_r($server_response);
                            // echo "fg ,", $server_response["current_round"]["total_fs_win_amount"];
                            // $details = $server_response["current_round"]['payline_wins']['details'];
                            // if (strlen($details) > 0) {
                            //     $str_arr = explode(";", $details);
                            //     for ($k = 0; $k < count($str_arr); $k++) {
